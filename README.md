...
![image](https://github.com/absolutezero2730/AXI_DMA_FIFO/blob/master/catch01.PNG)
6. In the Select area, select <b>Boards</b>.
![image](https://github.com/absolutezero2730/AXI_DMA_FIFO/blob/master/catch02.PNG)
